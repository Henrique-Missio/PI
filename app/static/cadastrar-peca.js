const mensagem     = document.getElementById("mensagem-peca");
...
btnCadastrar.addEventListener("click", async () => {
  ...
  const dados = { nome, marca, informacoes, status, problema: problema || null };
  ...
  try {
    ...
    mostrarSucesso("Peça cadastrada com sucesso!");
