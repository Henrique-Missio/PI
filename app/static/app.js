...
function renderizarAuth() {
  ...
  if (usuarioAtual) {
    ...
    nome.textContent = `Olá, ${usuarioAtual.nome_completo.split(" ")[0]}`;

    const btnPerfil = document.createElement("a");
    btnPerfil.href = "/perfil";
    btnPerfil.className = "btn btn-secondary btn-sm";
    btnPerfil.textContent = "Perfil";

    const btnSair = document.createElement("button");
    btnSair.className = "btn btn-secondary btn-sm";
